...
class Chip8CPU:
    def __init__(self, memory: Memory, screen: VirtualScreen) -> None:
        ...
        self.instructions_FFFF: dict[int, Callable[[Decoder], None]] = {
            0x00E0: self.clear_screen,
            0x00EE: self.return_from_subroutine,
        }

        self.instructions_F000: dict[int, Callable[[Decoder], None]] = {
        ...
        self.instructions_F00F: dict[int, Callable[[Decoder], None]] = {
    ...
    def _execute_instruction(self, pressed_key: str | None = None) -> None:
